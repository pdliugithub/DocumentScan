package com.rossia.life.scan.ui.view;
...
public class DrawColorView extends View {
    ...
    private DrawColorListener mDrawColorListener;
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if(mDrawColorListener != null){
            mDrawColorListener.drawColor(canvas);
        }
    }

    public void draw(DrawColorListener listener){
        mDrawColorListener = listener;
        postInvalidate();
    }

    public interface DrawColorListener{
